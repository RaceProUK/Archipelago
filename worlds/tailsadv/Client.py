...
class TailsAdvClient(BizHawkClient):
    ...
    async def __process_location_check(self, ctx: "BizHawkClientContext", item_obtained, item_pickup):
    ...
    async def __process_received_items(self, ctx: "BizHawkClientContext", session_state_data):
